...
| S1-M3-ENG05 | - | ENG | OSF freeze artefacts: helios/research package, seeds.py, analysis_plan.py, verify_osf_freeze.py --generate/--verify/--populate-prereg | §3.3, §3.6.8 | Design | methodology | AA | S1-M3-RES03 | IN_PROGRESS | 2026-05-19 | - | 46669f6 | - | - | - | - | helios/research/seeds.py + analysis_plan.py; bin/verify_osf_freeze.py; research/osf/ artefacts generated |
| S1-M3-ENG06 | - | ENG | OSF notebook + CI: research/ablation_notebook.ipynb + osf-freeze-verify + ablation-notebook CI jobs | §3.6.8 | Design | infra | AA | S1-M3-ENG05 | IN_PROGRESS | 2026-05-19 | - | 46669f6 | - | - | - | - | L0-L3 ablation matrix; CI verifies on every push |
| S1-M3-RES04 | - | RES | Tracking docs update: tracking_documents_register.md + reproducibility_manifest.md + pyproject.toml comment fix | §B.12, §3.3 | Communicate | methodology | AA | S1-M3-ENG06 | IN_PROGRESS | 2026-05-19 | - | 46669f6 | - | - | - | - | G3-8 evidence; manifest_sig recorded in reproducibility_manifest.md |
| S1-M3-GATE03 | - | GATE | OSF protocol freeze exit gate — G3-1 through G3-8 all PASS | §3.3, §5.3 | Evaluate | methodology | AA | S1-M3-RES04 | IN_PROGRESS | 2026-05-19 | - | 46669f6 | - | - | - | - | verify_osf_freeze.py --verify exits 0; manifest_sig matches; CI jobs pass |
