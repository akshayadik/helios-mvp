...
| S1-M3-ENG03 | - | ENG | L-pipe foundation: lpipe_config.py, OllamaClient, PromptRegistry, prompt_version_registry.md | §3.6.7, §3.3 | Design | C2 | AA | S1-M3-ENG01 | IN_PROGRESS | 2026-05-19 | - | - | - | - | - | - | llama3.1:8b via Ollama; SHA-256 prompt pinning; rca_v1 template |
| S1-M3-ENG04 | - | ENG | L-pipe completion: ResponseHandler, pipeline.py, runner.py integration, stub.py removal | §3.6.7, §3.6.8 | Design | C2 | AA | S1-M3-ENG03 | IN_PROGRESS | 2026-05-19 | - | - | - | - | - | - | @gated_by(VCLFlag.LPIPE); EXPECTED_PROMPT_SHA bootstrap guard |
| S1-M3-RES03 | - | RES | Deviation log entries: L-pipe model downgrade (llama3.1:8b) + Ollama runtime substitution | §B.12, §3.3 | Evaluate | methodology | AA | S1-M3-ENG04 | IN_PROGRESS | 2026-05-19 | - | - | - | - | - | - | dev IDs: 29789db26fba9b1d, b7812340df247f8a |
