...
| Task_ID | Day | Type | Description | Prop_§ | DSR | Contrib | Own | Deps | Status | Started | Done | SHA | Ev_Type | Ev_Ref | Gate | Dev_Ref | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S0-D5-ENG01 | 5 | ENG | vcl/snapshot_registry.py: register/verify (append-only JSONL) | §6.2, §3.6.5 | Design | C1 | AA | S0-D3-ENG01 | IN_PROGRESS | 2026-05-13 | - | - | TEST | tests/test_snapshot_registry.py | EG4 | - | Content-addressable identity |
| S0-D5-ENG02 | 5 | ENG | pipelines/{g,l}_pipe/stub.py: gated null stubs | §3.6.7 | Design | infra | AA | S0-D1-ENG05 | IN_PROGRESS | 2026-05-13 | - | - | TEST | tests/test_pipelines.py::test_gated | - | - | Behind l2b_graph, l2c_llm |
| S0-D5-ENG03 | 5 | ENG | store/result_store.py: DuckDB insert + inclusion-rate helper | §3.7 | Design | infra | AA | S0-D3-ENG05 | IN_PROGRESS | 2026-05-13 | - | - | TEST | tests/test_result_store.py | EG4 | - | Per-cell completion logic |
| S0-D5-ENG04 | 5 | ENG | tests/test_e2e_smoke.py: full pipeline (Parquet → DuckDB row) | §6.1-§6.4 | Evaluate | C1 | AA | S0-D5-ENG01,S0-D5-ENG03 | IN_PROGRESS | 2026-05-13 | - | - | TEST | tests/test_e2e_smoke.py::test_full | EG4 | - | THE binding integration test |
